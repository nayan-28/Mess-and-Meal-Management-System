        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center" style="text-decoration: none;">
                    <a href="{{ route('border.dashboard') }}" style="text-decoration: none;">
                        <h4>Amar Mess</h4>
                    </a>
                </div>
                <!-- Navigation Links -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!-- Authentication -->
                        <form method="POST" action="{{ route('border.logout') }}">
                            @csrf
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200">
                    {{ auth('border')->user()->name }}
                </div>
                <div class="font-medium text-sm text-gray-500">{{ auth('border')->user()->email }}</div>
            </div>
